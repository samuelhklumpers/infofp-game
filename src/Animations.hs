...
{- In this module, we handle animations.
 ...
 -
 - The reaper will call the deathToAnimation when a being dies. 
 -
...
deathToAnimation :: Being -> TimedAnimation
deathToAnimation b = case b ^. race of
                         Bullet -> explode b
                         _      -> implode b
...
stepAnimation :: Float -> TimedAnimation -> TimedAnimation
stepAnimation dt (ani, t) = (ani, t - animationspeed * dt)
...
animationsStep dt = cleanAnimations . map (stepAnimation dt)